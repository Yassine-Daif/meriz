...
/** Nom donné au document créé par « Découvrir avec l'exemple ». */
export const EXAMPLE_NAME = 'Exemple : Client passe Commande'
 ...
 * les types du modèle. Il sert aussi de fixture aux tests.
 */
...
/**
 * Positions de l'exemple, séparées du modèle (voir layout.ts) :
 * les deux entités de part et d'autre de l'association.
 */
